...
| `consumers_subnet_id` | `string` | | **Required** | The id of the subnet where services that will consume this storage account will reside. Typically a vnet integration subnet |
